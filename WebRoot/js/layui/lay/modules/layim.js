...
;layui.define(["layer", "laytpl", "upload"], function (i) {
    var a = "3.0.1 Pro", e = layui.jquery, t = layui.layer, n = layui.laytpl, l = layui.device(), s = "layui-show", o = "layim-this", r = 20, d = {}, c = function () {
    ...
    var x, b, w, k, C, S = function (i, a, n) {
        ...
        if (a[0]) {
            var s = w.find(".layim-chat-list"), o = s.find(".layim-chatlist-" + i.type + i.id), r = w.find(".layui-layer-max").hasClass("layui-layer-maxmin"), c = a.children(".layim-chat-box");
        ...
        var n = i.index() === -1 ? 0 : i.index(), l = ".layim-chat", r = w.find(l).eq(n), c = w.find(".layui-layer-max").hasClass("layui-layer-maxmin");
        if (a) {
        ...
        if (w) {
            var i = e(".layim-chat-list ." + o).index(), a = w.find(".layim-chat").eq(i), t = JSON.parse(decodeURIComponent(a.find(".layim-chat-tool").data("json")));
        ...
        var i = layui.data("layim")[j.mine.id] || {}, a = O(), e = i.chatlog || {}, t = a.elem.find(".layim-chat-main ul");
        ...
        status: function (i, a) {
            ...
            var a = x.find(".layui-layim-search"), e = x.find("#layui-layim-search"), t = a.find("input"), n = function (i) {
            ...
            var a = layui.data("layim")[j.mine.id] || {}, e = i.data("type"), t = i.data("index"), n = i.attr("data-list") || i.index(), l = {};
            ...
            i.data("down") ? l() : (n.html("&#xe619;"), i.data("down", !0), ei.groupMembers.index = t.tips('<ul class="layim-members-list"></ul>', i, {
                ...
                success: function (a) {
                    var t = j.base.members || {}, n = O(), s = a.find(".layim-members-list"), o = "", r = {}, c = w.find(".layui-layer-max").hasClass("layui-layer-maxmin"), u = "none" === w.find(".layim-chat-list").css("display");
            ...
            var n = layui.data("layim")[j.mine.id] || {}, l = i.parent(), s = i.data("type"), o = x.find(".layim-list-history"), r = '<li class="layim-null">暂无历史会话</li>';
            if ("one" === s) {
                var d = n.history;
